...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="/lists" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="https://freesvg.org./storage/img/thumb/1570429924tvset.png" class="h-8" alt="Flowbite Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">navbar_layout</span>
    </a>
